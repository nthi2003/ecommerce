...
const ButtonComponent = ({placeholder}) => {
  return (
    <div className=' '>
        ...
        <span className="before:absolute before:border-l before:border-gray-300 before:h-[24px] before:top-[8px] before:left-0"></span>
          Tìm kiếm
        </button>
    </div>
  )
